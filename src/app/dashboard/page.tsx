  ...
  return (
    <ProtectedRoute>
      <div className="space-y-8">
        ...
        <div className="flex items-center gap-3 p-4 rounded-xl bg-surface border border-line">
          <div
            className={`w-3 h-3 rounded-full ${
              isPremium ? "bg-success" : "bg-warning"
            }`}
          />
          ...
          {!isPremium && (
            <Link
              ...
              className="ml-auto text-sm font-medium text-accent-ink hover:text-accent-ink transition-colors"
            >
              Upgrade
            </Link>
          )}
        ...
        <div className="grid grid-cols-2 gap-3">
          <Link
            ...
            className="flex flex-col items-center justify-center gap-2 p-6 rounded-2xl bg-surface border border-line hover:border-accent transition-colors"
          >
            <svg className="w-8 h-8 text-accent-ink" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
