...
-- AddForeignKey
ALTER TABLE "analyses" ADD CONSTRAINT "analyses_photo_a_id_fkey" FOREIGN KEY ("photo_a_id") REFERENCES "photos"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "analyses" ADD CONSTRAINT "analyses_photo_b_id_fkey" FOREIGN KEY ("photo_b_id") REFERENCES "photos"("id") ON DELETE CASCADE ON UPDATE CASCADE;
